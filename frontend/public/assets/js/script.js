...
document.addEventListener("DOMContentLoaded", function(){
    ...
    // get_link.innerHTML = '<a href="https://therichpost.com/" class="btn btn-dark rounded-pill" style="font-size:13px; z-index:100; position: fixed; bottom:10px; right:10px;"></a>'
