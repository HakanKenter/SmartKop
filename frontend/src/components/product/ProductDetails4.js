        ...
        <Fragment>
            {loading ? <Loader /> : (
                <Fragment>
                    ...
                    <div className="product-detail-display row f-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            ...
                            <span id="no_of_reviews">{product.numOfReviews} Commentaires</span>
                            ...
                            <p>Statut: <span id="stock_status" className={product.stock > 0 ? 'greenColor' : 'redColor'}>{product.stock > 0 ? 'En Stock' : 'Rupture de stock'}</span></p>
